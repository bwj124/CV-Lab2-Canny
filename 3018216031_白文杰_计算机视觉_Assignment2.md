...
## Part 2 使用OpenCV内置Canny函数实现边缘提取

#### 函数的定义

![image-20210412122759100](C:\Users\董浩\AppData\Roaming\Typora\typora-user-images\image-20210412122759100.png)

> 其中要设置的参数主要是两个阈值的大小(threshold1和threshold2，分别代表双阈值中的小阈值和大阈值)

#### 效果实现

1. 输入原图原图
   ![100](E:\bwj\图片\壁纸\Win10壁纸\100.jpg)
2. 调用函数`Canny(image, opencvCanny, 80, 200);`
3. 输出图像
   ![100-0](E:\bwj\图片\壁纸\Win10壁纸\100-0.jpg)



## Part 3 使用自己编写的Canny函数实现边缘提取

1. 将输入图像转换为灰度图
   ![100-gray](E:\在学\计算机视觉\作业\作业2\images\100-gray.jpg)
2. 高斯模糊去除噪声
   ![100-gauss](E:\在学\计算机视觉\作业\作业2\images\100-gauss.jpg)
3. 对图像求梯度获取边缘信息
   ![100-imageXY](E:\在学\计算机视觉\作业\作业2\images\100-imageXY.jpg)
4. 非极大值抑制以获得细边缘
   ![100-localIamge](E:\在学\计算机视觉\作业\作业2\images\100-localIamge.jpg)
5. 双阈值检测和边缘连接
   ![100-canny](E:\在学\计算机视觉\作业\作业2\images\100-canny.jpg)



## Part 4 实验结果分析

自己实现的效果要比opencv内置函数的差。原因：非极大值抑制处的细化效果不是很好。
